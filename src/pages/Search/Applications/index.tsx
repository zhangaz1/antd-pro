...
interface ApplicationsProps {
  ...
  searchAndApplications: StateType;
  loading: boolean;
}
...
export const Applications: FC<ApplicationsProps> = (props) => {
  const {
    dispatch,
    loading,
    searchAndApplications: { list },
  } = props;

  useEffect(() => {
    dispatch({
      type: 'searchAndApplications/fetch',
      payload: {
        count: 8,
      },
    });
...
export default connect(
  ({
    ...
    searchAndApplications,
    loading: loading.models.searchAndApplications,
  }),
)(Applications);
